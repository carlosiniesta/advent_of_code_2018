...
class FrecuencyCalculator
  ...
  attr_accessor :actual_frecuency, :reached_frecuencies

  def run
    FRECUENCY_INPUTS.cycle do |frecuency|
      @actual_frecuency += frecuency
